...
public class TabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // \n this to next line
        content.add(new Items("Hi there","Welcome on onboard","Have a look of this application design for you \neasy to use and help full  for learn ",R.drawable.one));
        content.add(new Items("","Welcome on onboard","Have a look of this application design for you \neasy to use and help full  for learn ",R.drawable.two));
        content.add(new Items("","Welcome on onboard","Have a look of this application design for you \neasy to use and help full  for learn ",R.drawable.three));
